...
use Evolution\MobileVikings\Utils\OAuth;
use Evolution\MobileVikings\Utils\Curl;

/*
 *  Class allowing integration with Mobile Vikings API.
...
class MobileVikings extends OAuth {
  
  const MOBILEVIKINGS_SIGNATURE_METHOD = 'HMAC-SHA1';
  const MOBILEVIKINGS_AUTH_OAUTH = 'oauth';
  const MOBILEVIKINGS_AUTH_BASIC = 'basic';
  ...
  protected $userAgent      = 'Evolution MobileVikings (http://)';
   ...
   * 
   * @return MobileVikingsJson Object 
   */
  ...
  {
    parent::__construct($consumerKey, $consumerSecret, self::MOBILEVIKINGS_SIGNATURE_METHOD);
  ...
  private function request($method, $endpoint, $params = null)
  {
    ...
    $resp= new MobileVikingsJson(call_user_func(array($this, 'httpRequest'), $method, $url, $params, $this->isMultipart($params)), $this->debug);
  ...
  private function request_basic($method, $endpoint, $params = null, $username = null, $password = null)
  {
    ...
    $resp = new MobileVikingsJson(Curl::getInstance()->addCurl($ch), $this->debug);
    if(!$this->isAsynchronous)
      $resp->response;
...
class MobileVikingsJson implements \ArrayAccess, \Countable, \IteratorAggregate
{
  private $debug;
  private $__resp;
  ...
  public function __get($name)
  {
    ...
    elseif(($this->code < 200 || $this->code >= 400) && !isset($accessible[$name]))
      MobileVikingsException::raise($this->__resp, $this->debug);
...
class MobileVikingsException extends \Exception 
{
  public static function raise($response, $debug)
  {
    ...
    {
      case 400:
        throw new MobileVikingsBadRequestException($message, $response->code);
      case 401:
        throw new MobileVikingsNotAuthorizedException($message, $response->code);
      case 403:
        throw new MobileVikingsForbiddenException($message, $response->code);
      case 404:
        throw new MobileVikingsNotFoundException($message, $response->code);
      case 406:
        throw new MobileVikingsNotAcceptableException($message, $response->code);
      case 420:
        throw new MobileVikingsEnhanceYourCalmException($message, $response->code);
      case 500:
        throw new MobileVikingsInternalServerException($message, $response->code);
      case 502:
        throw new MobileVikingsBadGatewayException($message, $response->code);
      case 503:
        throw new MobileVikingsServiceUnavailableException($message, $response->code);
      default:
        throw new MobileVikingsException($message, $response->code);
    }
  }
}
class MobileVikingsBadRequestException extends MobileVikingsException{}
class MobileVikingsNotAuthorizedException extends MobileVikingsException{}
class MobileVikingsForbiddenException extends MobileVikingsException{}
class MobileVikingsNotFoundException extends MobileVikingsException{}
class MobileVikingsNotAcceptableException extends MobileVikingsException{}
class MobileVikingsEnhanceYourCalmException extends MobileVikingsException{}
class MobileVikingsInternalServerException extends MobileVikingsException{}
class MobileVikingsBadGatewayException extends MobileVikingsException{}
class MobileVikingsServiceUnavailableException extends MobileVikingsException{}